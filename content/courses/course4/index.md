---
title: "PAI 724 – Data Driven Decision Making"
date: 2022-08-29
author: "Graham Ambrose"
description: "Syllabus and schedule for PAI 724: Data Driven Decision Making (Fall 2022)."
summary: "Course syllabus for PAI 724 – Data Driven Decision Making."
cover:
    image: "course4.jpg"
    alt: "PAI 724 – Data Driven Decision Making"
    relative: true
...
lessons:
  - code: "Lesson_1"
    title: "Python for Everyone Chapters 1 and 2"
    summary: "Course overview, goals, and how data informs public decisions."
  - code: "Lesson_2"
    title: "Python for Everyone Chapters 3 and 4"
    summary: "This lesson works through conditional execution using Boolean expressions and conditional operators as well as programing new functions in Python."
  - code: "Lesson_3"
    title: "Python for Everyone Chapters 5"
    summary: "This lesson works through iterations using while functions and for loops in Python."
  - code: "Lesson_4"
    title: "Python for Everyone Chapters 6"
    summary: "This lesson dives into manipulating string objects in Python."
  - code: "Lesson_5"
    title: "Python for Everyone Chapters 7 and 8"
    summary: "This lesson teaches students how to upload files into Colab, but largely focuses on engaging with and manipulating text files, and list operations."
  - code: "Lesson_6"
    title: "Python for Everyone Chapters 9"
    summary: "This lesson introduces the structure of and practical us of dictionaries."
  - code: "Lesson_7"
    title: "Intro to R and the tidyverse"
    summary: "This lesson works as a transition from python to R. Furthermore, tibble, readr, dplyr, and tidyr are introduced as tools to engage and manipulate not just data but datasets."
  - code: "Lesson_8"
    title: "Extending R to ggplot2"
    summary: "This lesson reviews the content covered in the last section and extends it to data visualization using ggplot2."
  - code: "Lesson_9"
    title: "Data Visualization using R"
    summary: "This lesson was developed as an in class exercise structure so the class has to think through the data visualization process."
---
...
📄 [PAI 724 – Fall 2022 Syllabus (PDF)](Ambrose_Data_Driven_Decision_Making_PAI_724.pdf)
